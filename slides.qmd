...
author: "Olexandr Konovalov, Michael Tso, Alessandro Felder"
format:
  revealjs: 
    theme: simple
---
...
## Demo of preview site

![](images/4_fork.png){height=300}

(but that's what we did... at least we say so on the main README!)

## Demo of preview site


![](images/5_readme.png){height=300}

(but that's what we did... at least we say so on the main README!)

## Sample translation: proof of concept

![](images/ua.png){height=200}
![](images/zh.png){height=200}
![](images/de.png){height=200}
